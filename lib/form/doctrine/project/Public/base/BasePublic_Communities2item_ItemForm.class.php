...
/**
 * Public_Communities2item_Item form base class.
 *
 * @method Public_Communities2item_Item getObject() Returns the current form's model object
 *
 * @package    dspace
 * @subpackage form
 ...
 */
abstract class BasePublic_Communities2item_ItemForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('public_communities2item_item[%s]');
