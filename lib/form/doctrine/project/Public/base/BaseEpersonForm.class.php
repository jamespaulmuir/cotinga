...
/**
 * Eperson form base class.
 *
 * @method Eperson getObject() Returns the current form's model object
 *
 * @package    dspace
 * @subpackage form
 ...
 */
abstract class BaseEpersonForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('eperson[%s]');
