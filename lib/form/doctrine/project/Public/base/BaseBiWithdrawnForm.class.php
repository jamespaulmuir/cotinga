...
/**
 * BiWithdrawn form base class.
 *
 * @method BiWithdrawn getObject() Returns the current form's model object
 *
 * @package    dspace
 * @subpackage form
 ...
 */
abstract class BaseBiWithdrawnForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('bi_withdrawn[%s]');
