...
/**
 * Public_Bi4Dmap_Item form base class.
 *
 * @method Public_Bi4Dmap_Item getObject() Returns the current form's model object
 *
 * @package    dspace
 * @subpackage form
 ...
 */
abstract class BasePublic_Bi4Dmap_ItemForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'distinct_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Public_Bi4Dis_Item'), 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('public_bi4_dmap_item[%s]');
