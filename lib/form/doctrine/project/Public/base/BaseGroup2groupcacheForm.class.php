...
/**
 * Group2groupcache form base class.
 *
 * @method Group2groupcache getObject() Returns the current form's model object
 *
 * @package    dspace
 * @subpackage form
 ...
 */
abstract class BaseGroup2groupcacheForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('group2groupcache[%s]');
