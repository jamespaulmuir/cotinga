...
/**
 * Public_Item2bundle_Item form base class.
 *
 * @method Public_Item2bundle_Item getObject() Returns the current form's model object
 *
 * @package    dspace
 * @subpackage form
 ...
 */
abstract class BasePublic_Item2bundle_ItemForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('public_item2bundle_item[%s]');
