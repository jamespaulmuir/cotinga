...
/**
 * Public_HarvestedItem_Item form base class.
 *
 * @method Public_HarvestedItem_Item getObject() Returns the current form's model object
 *
 * @package    dspace
 * @subpackage form
 ...
 */
abstract class BasePublic_HarvestedItem_ItemForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'oai_id'         => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'oai_id'         => new sfValidatorString(array('required' => false)),
      'id'             => new sfValidatorDoctrineChoice(array('model' => $this->getModelName(), 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('public_harvested_item_item[%s]');
