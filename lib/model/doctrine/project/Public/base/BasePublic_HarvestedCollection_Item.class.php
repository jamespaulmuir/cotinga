...
Doctrine_Manager::getInstance()->bindComponent('Public_HarvestedCollection_Item', 'doctrine');

/**
 * BasePublic_HarvestedCollection_Item
 * 
 ...
 * @method Public_HarvestedCollection_Item setCollectionId()           Sets the current record's "collection_id" value
 * @method Public_HarvestedCollection_Item setHarvestType()            Sets the current record's "harvest_type" value
 * @method Public_HarvestedCollection_Item setOaiSource()              Sets the current record's "oai_source" value
 * @method Public_HarvestedCollection_Item setOaiSetId()               Sets the current record's "oai_set_id" value
 * @method Public_HarvestedCollection_Item setHarvestMessage()         Sets the current record's "harvest_message" value
 * @method Public_HarvestedCollection_Item setMetadataConfigId()       Sets the current record's "metadata_config_id" value
 * @method Public_HarvestedCollection_Item setHarvestStatus()          Sets the current record's "harvest_status" value
 * @method Public_HarvestedCollection_Item setHarvestStartTime()       Sets the current record's "harvest_start_time" value
 * @method Public_HarvestedCollection_Item setLastHarvested()          Sets the current record's "last_harvested" value
 * @method Public_HarvestedCollection_Item setId()                     Sets the current record's "id" value
 * @method Public_HarvestedCollection_Item setPublicCollectionItem()   Sets the current record's "Public_Collection_Item" value
 * 
 * @package    dspace
 * @subpackage model
 ...
 */
abstract class BasePublic_HarvestedCollection_Item extends BaseDoctrineRecord
{
