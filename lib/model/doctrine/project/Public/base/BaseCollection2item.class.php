 ...
 * @method Item            getItemForItem()   Returns the current record's "Item_ForItem" value
 ...
 * @method Collection2item setItemForItem()   Sets the current record's "Item_ForItem" value
 * 
 * @package    dspace
 * @subpackage model
...
abstract class BaseCollection2item extends BaseDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasOne('Item as Item_ForItem', array(
             'local' => 'item_id',
             'foreign' => 'item_id'));
    }
}