...
Doctrine_Manager::getInstance()->bindComponent('MostRecentChecksum', 'doctrine');

/**
 * BaseMostRecentChecksum
 * 
 ...
 * @method MostRecentChecksum setBitstreamId()             Sets the current record's "bitstream_id" value
 * @method MostRecentChecksum setToBeProcessed()           Sets the current record's "to_be_processed" value
 * @method MostRecentChecksum setExpectedChecksum()        Sets the current record's "expected_checksum" value
 * @method MostRecentChecksum setCurrentChecksum()         Sets the current record's "current_checksum" value
 * @method MostRecentChecksum setLastProcessStartDate()    Sets the current record's "last_process_start_date" value
 * @method MostRecentChecksum setLastProcessEndDate()      Sets the current record's "last_process_end_date" value
 * @method MostRecentChecksum setChecksumAlgorithm()       Sets the current record's "checksum_algorithm" value
 * @method MostRecentChecksum setMatchedPrevChecksum()     Sets the current record's "matched_prev_checksum" value
 * @method MostRecentChecksum setResult()                  Sets the current record's "result" value
 * @method MostRecentChecksum setBitstream()               Sets the current record's "Bitstream" value
 * @method MostRecentChecksum setChecksumResults()         Sets the current record's "ChecksumResults" value
 * 
 * @package    dspace
 * @subpackage model
 ...
 */
abstract class BaseMostRecentChecksum extends BaseDoctrineRecord
{
