...
Doctrine_Manager::getInstance()->bindComponent('Bi2Dis', 'doctrine');
 ...
 * @method Bi2Dis              setId()          Sets the current record's "id" value
 * @method Bi2Dis              setDistinctId()  Sets the current record's "distinct_id" value
 * @method Bi2Dis              setAuthority()   Sets the current record's "authority" value
 * @method Bi2Dis              setValue()       Sets the current record's "value" value
 * @method Bi2Dis              setSortValue()   Sets the current record's "sort_value" value
 * @method Bi2Dis              setBi2Dmaps()    Sets the current record's "Bi2Dmaps" collection
 * 
 * @package    dspace
 * @subpackage model
 ...
 */
abstract class BaseBi2Dis extends BaseDoctrineRecord
{
