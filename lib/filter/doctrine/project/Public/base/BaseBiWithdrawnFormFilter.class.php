...
/**
 * BiWithdrawn filter form base class.
 *
 * @package    dspace
 * @subpackage filter
 ...
 */
abstract class BaseBiWithdrawnFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('bi_withdrawn_filters[%s]');
