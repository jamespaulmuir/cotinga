...
/**
 * Group2groupcache filter form base class.
 *
 * @package    dspace
 * @subpackage filter
 ...
 */
abstract class BaseGroup2groupcacheFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('group2groupcache_filters[%s]');
