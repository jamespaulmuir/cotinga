...
/**
 * Public_BiWithdrawn_Item filter form base class.
 *
 * @package    dspace
 * @subpackage filter
 ...
 */
abstract class BasePublic_BiWithdrawn_ItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('public_bi_withdrawn_item_filters[%s]');
