...
/**
 * Public_Bitstream_Item filter form base class.
 *
 * @package    dspace
 * @subpackage filter
 ...
 */
abstract class BasePublic_Bitstream_ItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('public_bitstream_item_filters[%s]');
