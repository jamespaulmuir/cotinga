...
/**
 * Public_Collection_Item filter form base class.
 *
 * @package    dspace
 * @subpackage filter
 ...
 */
abstract class BasePublic_Collection_ItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'template_item_id'       => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Public_Item_Item'), 'column' => 'item_id')),
      ...
      'workflow_step_1'        => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Public_Epersongroup_Item_ForWorkflowStep1'), 'column' => 'eperson_group_id')),
      'workflow_step_2'        => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Public_Epersongroup_Item_ForWorkflowStep2'), 'column' => 'eperson_group_id')),
      'workflow_step_3'        => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Public_Epersongroup_Item_ForWorkflowStep3'), 'column' => 'eperson_group_id')),
      'submitter'              => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Public_Epersongroup_Item_ForSubmitter'), 'column' => 'eperson_group_id')),
      'admin'                  => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Public_Epersongroup_Item_ForAdmin'), 'column' => 'eperson_group_id')),
    ));

    $this->widgetSchema->setNameFormat('public_collection_item_filters[%s]');
