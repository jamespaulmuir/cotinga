...
/**
 * Registrationdata filter form base class.
 *
 * @package    dspace
 * @subpackage filter
 ...
 */
abstract class BaseRegistrationdataFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('registrationdata_filters[%s]');
