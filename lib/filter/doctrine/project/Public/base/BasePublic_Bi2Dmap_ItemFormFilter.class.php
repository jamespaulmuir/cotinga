...
/**
 * Public_Bi2Dmap_Item filter form base class.
 *
 * @package    dspace
 * @subpackage filter
 ...
 */
abstract class BasePublic_Bi2Dmap_ItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'distinct_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Public_Bi2Dis_Item'), 'column' => 'id')),
    ));

    $this->widgetSchema->setNameFormat('public_bi2_dmap_item_filters[%s]');
