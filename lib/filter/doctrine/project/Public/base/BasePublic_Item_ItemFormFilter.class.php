...
/**
 * Public_Item_Item filter form base class.
 *
 * @package    dspace
 * @subpackage filter
 ...
 */
abstract class BasePublic_Item_ItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'submitter_id'      => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Public_Eperson_Item'), 'column' => 'eperson_id')),
    ...
    $this->widgetSchema->setNameFormat('public_item_item_filters[%s]');
