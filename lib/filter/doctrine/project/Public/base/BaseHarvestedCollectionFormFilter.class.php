...
/**
 * HarvestedCollection filter form base class.
 *
 * @package    dspace
 * @subpackage filter
 ...
 */
abstract class BaseHarvestedCollectionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('harvested_collection_filters[%s]');
