...
/**
 * ChecksumHistory filter form base class.
 *
 * @package    dspace
 * @subpackage filter
 ...
 */
abstract class BaseChecksumHistoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('checksum_history_filters[%s]');
